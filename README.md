...
<p align="center">
  <a href="https://github.com/ilpl/proxypool/actions">
    <img src="https://img.shields.io/github/workflow/status/zu1k/proxypool/Go?style=flat-square" alt="Github Actions">
  </a>
  <a href="https://goreportcard.com/report/github.com/ilpl/proxypool">
    <img src="https://goreportcard.com/badge/github.com/ilpl/proxypool?style=flat-square">
  </a>
  <a href="https://github.com/ilpl/proxypool/releases">
...
```sh
$ go get -u -v github.com/ilpl/proxypool
```

### 下载预编译程序

从这里下载预编译好的程序 [release](https://github.com/ilpl/proxypool/releases)

### 使用docker

```sh
docker pull docker.pkg.github.com/ilpl/proxypool/proxypool:latest
```
